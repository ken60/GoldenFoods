...
public class GoldenBeef extends ItemFood
{
	public GoldenBeef(int par2, float par3, boolean par4)
	{
		super(par2, par3, par4);
		this.setCreativeTab(ModCreativeTab.tabMod);
		this.setUnlocalizedName("goldenBeef");
		this.setTextureName("goldenfoods:goldenBeef");
