...
public class GoldenChicken extends ItemFood
{
	public GoldenChicken(int par2, float par3, boolean par4)
	{
		super(par2, par3, par4);
		this.setCreativeTab(ModCreativeTab.tabMod);
		this.setUnlocalizedName("goldenChicken");
		this.setTextureName("goldenfoods:goldenChicken");
